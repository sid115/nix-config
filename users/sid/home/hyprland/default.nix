...

{
  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      windowrulev2 = [
        ...
        "workspace  9, class:^Jan$, title:^Jan"
  ...
  home.shellAliases = {
    ...
    synapse_change_display_name = "${
      inputs.core.packages.${pkgs.system}.synapse_change_display_name
    }/bin/synapse_change_display_name -t $(${pkgs.pass}/bin/pass sid.ovh/matrix/access-token) -r sid.ovh";
  };
}
